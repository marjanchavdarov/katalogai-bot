...
<label>Resume Job ID (optional - paste if previous upload got stuck):</label>
...
def filter_products(message, active, upcoming):
    translations = {
        ...
        # Serbian
        "mleko": "milk", "mleka": "milk", "meso": "meat",
        "hleb": "bread", "hljeb": "bread", "pivo": "beer",
        "riba": "fish", "jaja": "eggs", "sir": "cheese",
        # Spanish
        "leche": "milk", "carne": "meat", "pollo": "chicken",
        "pan": "bread", "fruta": "fruit", "verdura": "vegetables",
        "yogur": "yogurt", "queso": "cheese", "pescado": "fish",
        "cerveza": "beer", "vino": "wine", "zumo": "juice",
        "cafe": "coffee", "te": "tea", "huevos": "eggs",
        "chocolate": "chocolate", "jabón": "soap", "mascotas": "pets",
        # German
        "milch": "milk", "fleisch": "meat", "huhn": "chicken",
        "brot": "bread", "obst": "fruit", "gemuse": "vegetables",
        "joghurt": "yogurt", "kase": "cheese", "fisch": "fish",
        "bier": "beer", "wein": "wine", "saft": "juice",
        "kaffee": "coffee", "tee": "tea", "eier": "eggs",
        "schokolade": "chocolate", "seife": "soap",
        # Swedish
        "mjolk": "milk", "kott": "meat", "kyckling": "chicken",
        "brod": "bread", "frukt": "fruit", "gronsaker": "vegetables",
        "ost": "cheese", "fisk": "fish", "ol": "beer",
        "kaffe": "coffee", "choklad": "chocolate", "agg": "eggs",
        # French
        "lait": "milk", "viande": "meat", "poulet": "chicken",
        "pain": "bread", "fruit": "fruit", "legumes": "vegetables",
        "yaourt": "yogurt", "fromage": "cheese", "poisson": "fish",
        "biere": "beer", "jus": "juice", "cafe": "coffee",
        "oeufs": "eggs", "chocolat": "chocolate",
        # Italian
        "latte": "milk", "carne": "meat", "pollo": "chicken",
        "pane": "bread", "frutta": "fruit", "verdure": "vegetables",
        "yogurt": "yogurt", "formaggio": "cheese", "pesce": "fish",
        "birra": "beer", "succo": "juice", "caffe": "coffee",
        "uova": "eggs", "cioccolato": "chocolate",
    }
...
def ask_gemini(message, products, user, conversation):
    ...
    prompt = (
        ...
        "- Use all data you can get to give the users. You are like google for katalogs. Use pictures freely they give us credbility.\n"
